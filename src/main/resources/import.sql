...
-- ───────────────────────────────────────────────────────────────────
-- 1. Insertar la prueba de aptitud base (PruebaAptitud + TestNumerico)
--    Usa JOINED inheritance: primero la fila padre, luego la hija.
-- ───────────────────────────────────────────────────────────────────

INSERT INTO PruebaAptitud (idPrueba, nombre, tiempoLimiteMinutos, TIPO_PRUEBA)
VALUES (1, 'Test Numérico - Factor N2 (Operaciones y Problemas)', 12, 'TEST_NUMERICO');

INSERT INTO TestNumerico (idPrueba, tiempoOperacionesMin, tiempoProblemasMin)
VALUES (1, 6, 6);
...
-- Pregunta 1 (Q57)
INSERT INTO Pregunta (id, orden, seccion, enunciado, prueba_id)
VALUES (1, 1, 'OPERACIONES', '[ ] — 14.47 — 23.36 = 4', 1);
...
-- Pregunta 2 (Q58)
INSERT INTO Pregunta (id, orden, seccion, enunciado, prueba_id)
VALUES (2, 2, 'OPERACIONES', '7.28 — 2.53 — [ ] = 1.49', 1);
...
-- Pregunta 3 (Q59)
INSERT INTO Pregunta (id, orden, seccion, enunciado, prueba_id)
VALUES (3, 3, 'OPERACIONES', '3.39 — 3.25 + [ ] — 2.33 = 2', 1);
...
-- Pregunta 4 (Q60)
INSERT INTO Pregunta (id, orden, seccion, enunciado, prueba_id)
VALUES (4, 4, 'OPERACIONES', '[ ] — 12,68 + 18,89 — 1,89 = 28.89', 1);
...
-- Pregunta 5 (Q61)
INSERT INTO Pregunta (id, orden, seccion, enunciado, prueba_id)
VALUES (5, 5, 'OPERACIONES', '(5,73 + 1,27) / (5,63 + [ ]) = 1', 1);
...
-- Pregunta 6 (Q62)
INSERT INTO Pregunta (id, orden, seccion, enunciado, prueba_id)
VALUES (6, 6, 'OPERACIONES', '(7,54 + 3,08) / (9,63 - [ ]) = 3', 1);
...
-- Pregunta 7 (Q63)
INSERT INTO Pregunta (id, orden, seccion, enunciado, prueba_id)
VALUES (7, 7, 'OPERACIONES', '([ ] x 6) / 3 = 16.6', 1);
...
-- Pregunta 8 (Q64)
INSERT INTO Pregunta (id, orden, seccion, enunciado, prueba_id)
VALUES (8, 8, 'OPERACIONES', '(2.6 x 0.37) / [ ] = 1', 1);
...
-- Pregunta 9 (Q65)
INSERT INTO Pregunta (id, orden, seccion, enunciado, prueba_id)
VALUES (9, 9, 'OPERACIONES', '1/3 + [ ] + 1/6 = 7/10', 1);
INSERT INTO OpcionRespuesta (id, literal, textoOpcion, esCorrecta, pregunta_id) VALUES (33, 'A', '1/4', false, 9);
INSERT INTO OpcionRespuesta (id, literal, textoOpcion, esCorrecta, pregunta_id) VALUES (34, 'B', '1/5', true, 9);
INSERT INTO OpcionRespuesta (id, literal, textoOpcion, esCorrecta, pregunta_id) VALUES (35, 'C', '1/3', false, 9);
INSERT INTO OpcionRespuesta (id, literal, textoOpcion, esCorrecta, pregunta_id) VALUES (36, 'D', '1/6', false, 9);

-- Pregunta 10 (Q66)
INSERT INTO Pregunta (id, orden, seccion, enunciado, prueba_id)
VALUES (10, 10, 'OPERACIONES', '(1/2 x 1/3) / [ ] = 2/3', 1);
INSERT INTO OpcionRespuesta (id, literal, textoOpcion, esCorrecta, pregunta_id) VALUES (37, 'A', '3/4', false, 10);
INSERT INTO OpcionRespuesta (id, literal, textoOpcion, esCorrecta, pregunta_id) VALUES (38, 'B', '3/2', false, 10);
INSERT INTO OpcionRespuesta (id, literal, textoOpcion, esCorrecta, pregunta_id) VALUES (39, 'C', '5/2', false, 10);
INSERT INTO OpcionRespuesta (id, literal, textoOpcion, esCorrecta, pregunta_id) VALUES (40, 'D', '1/4', true, 10);
...
-- Pregunta 11 (Q69)
INSERT INTO Pregunta (id, orden, seccion, enunciado, prueba_id)
VALUES (11, 1, 'PROBLEMAS', 'Jaime tiene 28 bolas. Juan tiene 17 bolas más que Jaime. ¿Cuántas bolas tienen entre los dos?', 1);
...
-- Pregunta 12 (Q70)
INSERT INTO Pregunta (id, orden, seccion, enunciado, prueba_id)
VALUES (12, 2, 'PROBLEMAS', 'Para su cumpleaños a Pablo le han regalado 36 bolas. Con el mismo gasto, ¿cuántas podrían haberle regalado si las bolas valiesen cuatro veces más caras?', 1);
...
-- Pregunta 13 (Q71)
INSERT INTO Pregunta (id, orden, seccion, enunciado, prueba_id)
VALUES (13, 3, 'PROBLEMAS', 'En el mercado, compro 3 onzas de vainilla a 4 córdobas la onza y 5 pasteles a 3 córdobas cada uno. Pago con un billete de 50 córdobas, ¿Cuántos deben devolverme?', 1);
...
-- Pregunta 14 (Q72)
INSERT INTO Pregunta (id, orden, seccion, enunciado, prueba_id)
VALUES (14, 4, 'PROBLEMAS', 'César murió en el —44 a la edad de 57 años. ¿Cuál es su año nacimiento?', 1);
...
-- Pregunta 15 (Q73)
INSERT INTO Pregunta (id, orden, seccion, enunciado, prueba_id)
VALUES (15, 5, 'PROBLEMAS', 'El historiador romano Tito Livio nació en el —59, murió a la edad de 75 años. ¿Cuál es el año de su muerte?', 1);
...
-- Pregunta 16 (Q74)
INSERT INTO Pregunta (id, orden, seccion, enunciado, prueba_id)
VALUES (16, 6, 'PROBLEMAS', 'Dar un número que sea divisible a la vez por 7 y 17.', 1);
...
-- Pregunta 17 (Q75)
INSERT INTO Pregunta (id, orden, seccion, enunciado, prueba_id)
VALUES (17, 7, 'PROBLEMAS', 'Cuánto debemos sumar al numerador de la fracción 5/24 para hacerla igual a 2/3.', 1);
...
-- Pregunta 18 (Q76)
INSERT INTO Pregunta (id, orden, seccion, enunciado, prueba_id)
VALUES (18, 8, 'PROBLEMAS', 'Encontrar un número que sea igual a la mitad de la diferencia entre el cuadrado de 6 y el producto de 4 por el resto de la división de 26 por 7.', 1);
...
-- Pregunta 19 (Q77)
INSERT INTO Pregunta (id, orden, seccion, enunciado, prueba_id)
VALUES (19, 9, 'PROBLEMAS', 'Dar el resultado de la diferencia entre el cuadrado de 3 y el cociente de 3/2 por 5/2.', 1);
...
-- Pregunta 20 (Q78)
INSERT INTO Pregunta (id, orden, seccion, enunciado, prueba_id)
VALUES (20, 10, 'PROBLEMAS', 'Qué número es igual al tercio del producto de la suma de los dos productos (2/3 x 9) y (15/2 x 2/5) por la diferencia entre los dos productos 4 x 3 y (2/3 x 12).', 1);
...
INSERT INTO BaremoNacional (id, puntuacionDirectaMinima, puntuacionDirectaMaxima, percentil, nivelEstudio) VALUES (1, 13, 16, 99, NULL);
INSERT INTO BaremoNacional (id, puntuacionDirectaMinima, puntuacionDirectaMaxima, percentil, nivelEstudio) VALUES (2, 11, 12, 97, NULL);
INSERT INTO BaremoNacional (id, puntuacionDirectaMinima, puntuacionDirectaMaxima, percentil, nivelEstudio) VALUES (3, 9, 10, 95, NULL);
INSERT INTO BaremoNacional (id, puntuacionDirectaMinima, puntuacionDirectaMaxima, percentil, nivelEstudio) VALUES (4, 8, 8, 90, NULL);
INSERT INTO BaremoNacional (id, puntuacionDirectaMinima, puntuacionDirectaMaxima, percentil, nivelEstudio) VALUES (5, 7, 7, 85, NULL);
INSERT INTO BaremoNacional (id, puntuacionDirectaMinima, puntuacionDirectaMaxima, percentil, nivelEstudio) VALUES (6, 6, 6, 75, NULL);
INSERT INTO BaremoNacional (id, puntuacionDirectaMinima, puntuacionDirectaMaxima, percentil, nivelEstudio) VALUES (7, 5, 5, 60, NULL);
INSERT INTO BaremoNacional (id, puntuacionDirectaMinima, puntuacionDirectaMaxima, percentil, nivelEstudio) VALUES (8, 4, 4, 45, NULL);
INSERT INTO BaremoNacional (id, puntuacionDirectaMinima, puntuacionDirectaMaxima, percentil, nivelEstudio) VALUES (9, 3, 3, 35, NULL);
INSERT INTO BaremoNacional (id, puntuacionDirectaMinima, puntuacionDirectaMaxima, percentil, nivelEstudio) VALUES (10, 2, 2, 15, NULL);
INSERT INTO BaremoNacional (id, puntuacionDirectaMinima, puntuacionDirectaMaxima, percentil, nivelEstudio) VALUES (11, 1, 1, 5, NULL);
INSERT INTO BaremoNacional (id, puntuacionDirectaMinima, puntuacionDirectaMaxima, percentil, nivelEstudio) VALUES (12, 0, 0, 1, NULL);
...
SELECT setval(pg_get_serial_sequence('pruebaaptitud', 'idprueba'), (SELECT COALESCE(MAX(idPrueba), 1) FROM PruebaAptitud));
