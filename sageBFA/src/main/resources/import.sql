...
INSERT INTO PruebaAptitud (idPrueba, nombre, tiempoLimiteMinutos, TIPO_PRUEBA) VALUES (1, 'Test Numérico - Factor N2 (Operaciones y Problemas)', 12, 'TEST_NUMERICO');

INSERT INTO TestNumerico (idPrueba, tiempoOperacionesMin, tiempoProblemasMin) VALUES (1, 6, 6);
...
-- Pregunta 11 (Q69)
INSERT INTO Pregunta (id, orden, seccion, enunciado, prueba_id) VALUES (11, 1, 'PROBLEMAS', 'Jaime tiene 28 bolas. Juan tiene 17 bolas más que Jaime. ¿Cuántas bolas tienen entre los dos?', 1);
...
-- Pregunta 12 (Q70)
INSERT INTO Pregunta (id, orden, seccion, enunciado, prueba_id) VALUES (12, 2, 'PROBLEMAS', 'Para su cumpleaños a Pablo le han regalado 36 bolas. Con el mismo gasto, ¿cuántas podrían haberle regalado si las bolas valiesen cuatro veces más caras?', 1);
...
-- Pregunta 13 (Q71)
INSERT INTO Pregunta (id, orden, seccion, enunciado, prueba_id) VALUES (13, 3, 'PROBLEMAS', 'En el mercado, compro 3 onzas de vainilla a 4 córdobas la onza y 5 pasteles a 3 córdobas cada uno. Pago con un billete de 50 córdobas, ¿Cuántos deben devolverme?', 1);
...
-- Pregunta 14 (Q72)
INSERT INTO Pregunta (id, orden, seccion, enunciado, prueba_id) VALUES (14, 4, 'PROBLEMAS', 'César murió en el —44 a la edad de 57 años. ¿Cuál es su año nacimiento?', 1);
...
-- Pregunta 16 (Q74)
INSERT INTO Pregunta (id, orden, seccion, enunciado, prueba_id) VALUES (16, 6, 'PROBLEMAS', 'Dar un número que sea divisible a la vez por 7 y 17.', 1);
...
-- Pregunta 17 (Q75)
INSERT INTO Pregunta (id, orden, seccion, enunciado, prueba_id) VALUES (17, 7, 'PROBLEMAS', 'Cuánto debemos sumar al numerador de la fracción 5/24 para hacerla igual a 2/3.', 1);
...
-- Pregunta 18 (Q76)
INSERT INTO Pregunta (id, orden, seccion, enunciado, prueba_id) VALUES (18, 8, 'PROBLEMAS', 'Encontrar un número que sea igual a la mitad de la diferencia entre el cuadrado de 6 y el producto de 4 por el resto de la división de 26 por 7.', 1);
...
-- Pregunta 19 (Q77)
INSERT INTO Pregunta (id, orden, seccion, enunciado, prueba_id) VALUES (19, 9, 'PROBLEMAS', 'Dar el resultado de la diferencia entre el cuadrado de 3 y el cociente de 3/2 por 5/2.', 1);
...
-- Pregunta 20 (Q78)
INSERT INTO Pregunta (id, orden, seccion, enunciado, prueba_id) VALUES (20, 10, 'PROBLEMAS', 'Qué número es igual al tercio del producto de la suma de los dos productos (2/3 x 9) y (15/2 x 2/5) por la diferencia entre los dos productos 4 x 3 y (2/3 x 12).', 1);
